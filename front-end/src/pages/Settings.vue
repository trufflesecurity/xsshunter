                ...
                <card class="xss-card-container">
                    <div class="row pl-4 pr-4 p-2" style="display: block;">
                        ...
                        <card>
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">Valid PGP public keys here will have the victim PGP encrypt the payload. This can only be decrypted locally by the coorisponding private key. gpg --armor --export KEYID</h6>
                            <p class="card-text">
